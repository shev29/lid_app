      ...
      (o.m = n =
        {
          ...
          "./src/js/browser.js": function (e, t, n) {
            ...
            var r = {
              ...
              isChrome: function (e) {
                return !!(0 < arguments.length && void 0 !== e ? e : window)
                  .chrome;
              },
              isSafari: function () {
                return (
          ...
          "./src/js/functions.js": function (e, t, n) {
            ...
            function c(t) {
              ...
              var n = "mouseover";
              (i.default.isChrome() || i.default.isFirefox()) && (n = "focus");
              function r() {
                window.removeEventListener(n, r), t.onPrintDialogClose();
              ...
              print: function (e, t) {
                ...
                n
                  ? ((e.printableElement = (function e(t, n) {
                      var r = t.cloneNode();
                      var o = Array.prototype.slice.call(t.childNodes);
                      for (var i = 0; i < o.length; i++) {
                        var a;
                        -1 === n.ignoreElements.indexOf(o[i].id) &&
                          ((a = e(o[i], n)), r.appendChild(a));
                      }
                      n.scanStyles &&
                        1 === t.nodeType &&
                        r.setAttribute("style", Object(l.collectStyles)(t, n));
                      switch (t.tagName) {
                        case "SELECT":
                          r.value = t.value;
                          break;
                    ...
                    e.header && Object(l.addHeader)(e.printableElement, e),
                    r.default.send(e, t))
                ...
                r.printable.constructor !== Array &&
                  ...
                  r.printable.forEach(function (e) {
                    ...
                    t.setAttribute("style", r.imageStyle),
                      (t.src = e),
                      a.default.isFirefox() && ((n = t.src), (t.src = n));
            ...
            t.default = {
              init: function (e, t) {
                ...
                switch (p(r)) {
                  ...
                  case "object":
                    ...
                    (n.fallbackPrintable = n.base64
                      ? "data:application/pdf;base64,".concat(n.fallbackPrintable)
                      : n.fallbackPrintable),
                    n))
                      "printable" !== o &&
                        "fallbackPrintable" !== o &&
                        (n[o] = (void 0 !== r[o] ? r : n)[o]);
                    break;
                  default:
                    throw new Error(
                ...
                switch (
                  ...
                  "pdf" !== n.type &&
                    ((i.srcdoc =
                      "<html><head><title>" + n.documentTitle + "</title>"),
                    n.css &&
                      (Array.isArray(n.css) || (n.css = [n.css]),
                    ...
                    if (a.default.isIE())
                      try {
                        console.info(
                          ...
                          window.open(n.fallbackPrintable, "_blank").focus(),
              ...
              print: function (t, e) {
                ...
                (t.properties = t.properties.map(function (e) {
                  return {
                    ...
                    displayName: "object" === o(e) ? e.displayName : e,
                    columnSize:
                  ...
                  t.header && Object(c.addHeader)(t.printableElement, t),
                  (t.printableElement.innerHTML += (function (e) {
                    ...
                    for (var o = 0; o < n.length; o++)
                      r +=
                        ...
                        e.gridHeaderStyle +
                        '">' +
                        Object(c.capitalizePrint)(n[o].displayName) +
                        "</th>";
                    ...
                    for (var i = 0; i < t.length; i++) {
                      ...
                      for (var a = 0; a < n.length; a++) {
                        var l = t[i],
                          s = n[a].field.split(".");
                        if (1 < s.length)
                          for (var d = 0; d < s.length; d++) l = l[s[d]];
                        else l = l[n[a].field];
                        r +=
                          '<td style="width:' +
                          n[a].columnSize +
          ...
          "./src/js/pdf.js": function (e, t, n) {
            ...
            t.default = {
              print: function (e, t) {
                var n, r;
                e.base64
                  ? ((n = Uint8Array.from(atob(e.printable), function (e) {
                  ...
                  : ((e.printable = /^(blob|http|\/\/)/i.test(e.printable)
                      ...
                      : window.location.origin +
                        ("/" !== e.printable.charAt(0)
                          ? "/" + e.printable
                          : e.printable)),
                    ((r = new window.XMLHttpRequest()).responseType =
                      "arraybuffer"),
                    ...
                    r.addEventListener("load", function () {
                      return -1 === [200, 201].indexOf(r.status)
                        ? (Object(o.cleanUp)(e), void e.onError(r.statusText, r))
          ...
          "./src/js/print.js": function (e, t, n) {
              ...
              n = {
                send: function (n, e) {
                  ...
                  r.onload = function () {
                    var e, t;
                    "pdf" !== n.type
                      ? ((t = r.contentWindow || r.contentDocument).document &&
                          (t = t.document),
                        t.body.appendChild(n.printableElement),
                        "pdf" !== n.type &&
                          n.style &&
            ...
            function i(t, n) {
              try {
                if ((t.focus(), o.default.isEdge() || o.default.isIE()))
                  try {
                ...
                o.default.isFirefox() &&
                  ((t.style.visibility = "hidden"), (t.style.left = "-1px")),
                  Object(r.cleanUp)(n);
              }
            }
            t.default = n;
