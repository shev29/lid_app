...
<body>
    ...
    <div class="wrapper d-flex flex-column min-vh-100">
        <header class="header header-sticky justify-content-center p-0 mb-1">
            <div class="container-fluid border-bottom px-3 justify-content-center justify-content-md-between">
                <button class="header-toggler d-none d-md-flex align-items-center" type="button" data-current="hide" style="margin-inline-start: -12px;">
