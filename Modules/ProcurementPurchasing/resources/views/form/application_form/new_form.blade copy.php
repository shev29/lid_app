                                    ...
                                    @php
                                        if(count($dataForm['budgetSelected']) == 0) {
                                            ...
                                            echo '<div class="row">
                                                    <div class="col-10 pe-0 budgetRow d-flex gap-2" id="budgetNo_'.$id.'">
                                                        <div class="col-12 pe-0">
                                                            <select class="select2 selectBudget selectDesc" id="selectBudget1" name="budgetApplication[]">
                                                                <option></option>
                                                                '.$optionBudget.'
                                                            </select>
                                                        </div>
                                            ...
                                            foreach ($dataForm['budgetSelected'] as $rowBudget) {
                                                ...
                                                $arrId[] = $id;
                                                foreach ($dataForm['budgetList'] as $row) {
                                                    $selected = ($row['id'] == $rowCostCenter['budgetId']) ? ' selected' : '';
                                                ...
                                                echo '<div class="row'.$mt.'">
                                                    <div class="col-10 pe-0 budgetRow d-flex gap-2" id="budgetNo_'.$id.'">
                                                        <div class="col-8 pe-0">
                                                            <select class="select2 selectBudget selectDesc" id="selectBudget'.($x + 1).'" name="budgetApplication[]">
                                                                <option></option>
                                                                '.$optionBudget.'
                                                            </select>
                                                        </div>
                            ...
                            <div class="row form-group m-0 mb-md-1 px-0 py-1">
                                ...
                                <div class="col-sm-12 col-md-8" id="budgetAmountContainer">
                                    @foreach ($arrId as $index => $id)
                                        ...
                                        @endphp
                                        <div class="row{{$mt}}" id="budgetAmount_{{$id}}">
                                            <div class="col-5">
                                                <input type="text" class="form-control currencyValue" name="budgetAmountApplication[]" spellcheck="false" autocomplete="off" value="{{$dataForm['budgetAmount']}}" readonly>
                                            </div>
                                            <div class="col-2 pe-0">
                                                <input type="hidden" id="budgetWithinInput" name="budgetWithinInput[]" value="Within" readonly>
                                                <label for="budgetWithinApplication" id="budgetWithinLabel" class="col-form-label label-inline-input">{{$dataForm['budgetWithinOver']}}</label>
                                            </div>
                                            <div class="col-5">
                                                <input type="text" class="form-control currencyValue d-flex" name="budgetWithinApplication[]" spellcheck="false" autocomplete="off" value="{{$dataForm['budgetWithin']}}" readonly>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="col-sm-12 col-md-8">
                                    <div class="row">
                                        <div class="col-9 pe-0">
                                            <input type="text" class="form-control" id="reimburseApplication1" name="reimburseApplication[]" spellcheck="false" autocomplete="off" value="{{$dataForm['reimburseTo']}}">
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group d-flex align-items-center position-relative">
                                                <input type="text" class="form-control d-flex numberValue" id="reimburseApplicationPercentage1" name="reimburseApplicationPercentage[]" spellcheck="false" autocomplete="off" style="padding-right: 33px;" maxlength="6" value="{{$dataForm['reimburseToNext']}}">
                                                <span class="position-absolute end-0 top-0 h-100 d-flex align-items-center px-2">%</span>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    $('#purchaseTypeApplication').select2({
        ...
        $('#budgetNoApplication').removeClass('is-invalid');
        $('#budgetAmountApplication').removeClass('is-invalid');
        $('#budgetWithinApplication').removeClass('is-invalid');
        $('#budgetNoApplication').parent().find('div.invalid-feedback').remove();
        ...
        else if($('#budgetNoApplication').val().trim() == '' || $('#budgetNoApplication').val().trim() == '-') {
            $(`#modalDocumentFormTitle`).html(applicationType);
        }
        else {
    ...
    $(document).off('input', '#budgetNoApplication').on('input', '#budgetNoApplication', function (e) {
    ...
    $(document).off('input', '#budgetAmountApplication').on('input', '#budgetAmountApplication', function (e) {
        ...
        if($this.val() == '' || $this.val() == '-') {
            $('#budgetWithinInput').val('Within');
            $('#budgetWithinLabel').html('Within');
            $('#budgetWithinApplication').val('').trigger('change');
        }
        else {
            let withinOver;
            let budgetInput;
            ...
            $('#budgetWithinInput').val(withinOver);
            $('#budgetWithinLabel').html(withinOver);
            $('#budgetWithinApplication').val(formattedBudget);
    ...
    $(document).off('click', '#addBudget').on('click', '#addBudget', function (e) {
        ...
        $(this).closest('.row').parent().append(`<div class="row mt-2">
                                            <div class="col-10 pe-0 budgetRow d-flex gap-2" id="budgetNo_${id}">
                                                <div class="col-12 pe-0 budgetContainer">
                                                    <select class="select2 selectBudget" name="budgetApplication[]">
                                                        ${options}
                                                    </select>
                                                </div>
                                            </div>
        ...
        $('#budgetAmountContainer').append(`<div class="row mt-2" id="budgetAmount_${id}">
                                                <div class="col-5">
                                                    <input type="text" class="form-control currencyValue" name="budgetAmountApplication[]" spellcheck="false" autocomplete="off" readonly>
                                                </div>
                                                <div class="col-2 pe-0">
                                                    <input type="hidden" id="budgetWithinInput" name="budgetWithinInput[]" value="Within" readonly>
                                                    <label for="budgetWithinApplication" id="budgetWithinLabel" class="col-form-label label-inline-input">Within</label>
                                                </div>
                                                <div class="col-5">
                                                    <input type="text" class="form-control currencyValue d-flex" name="budgetWithinApplication[]" spellcheck="false" autocomplete="off" readonly>
                                                </div>
                                            </div>`);
