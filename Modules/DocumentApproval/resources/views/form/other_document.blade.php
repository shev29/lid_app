    ...
    <div id="headerContainer">
        <div class="row row-multi-col mb-3 pt-2 pb-1 bg-white">
            <div class="col-sm-4 mb-sm-0">
                ...
                <div class="form-group mb-3">
                    <label for="documentTitle" class="form-label">Document Title<span class="required"></span> :</label>
                    <textarea class="form-control autosize singleLine " spellcheck="false" maxlength="200" id="documentTitle" name="documentTitle"></textarea>
                </div>
            </div>
            <div class="col-sm-4 mb-sm-0">
                <div class="form-group mb-3">
    ...
    <div>
        <div class="row row-multi-col mb-3 bg-white" id="" data-item="">
            <div class="row-multi-col-header">
                <span style="display: inline">Document to Approve (pdf/doc/docx)</span><span class="required"></span>
            </div>
